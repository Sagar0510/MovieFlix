...
export default class Movies extends Component {
  ...
  loadMoreMovies = async () => {
    ...
    const res = await axios.get(
      `https://api.themoviedb.org/3/movie/popular?api_key=c0f13d320fbf83404d03fbcfde9ffdee&language=en-US&page=${newPage}`
    );
    let data = res.data;
    // console.log(data);
    this.setState({
  ...
  async componentDidMount() {
    //Side effects
    const res = await axios.get(
      `https://api.themoviedb.org/3/movie/popular?api_key=c0f13d320fbf83404d03fbcfde9ffdee&language=en-US&page=${this.state.currPage}`
    );
    let data = res.data;
    // console.log(data);
    this.setState({
